...
export default function About() {
  return (
    <div className="overflow-x-hidden bg-gradient-to-br from-blue-50/60 via-white/80 to-blue-100/60">
      {/* Hero Section */}
      <section className="relative min-h-[50vh] flex items-center justify-center text-center px-4 py-16">
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.8 }}
          className="relative z-10 max-w-3xl mx-auto bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl px-8 py-12 border border-blue-100"
        >
          <motion.h1
          ...
          <motion.p
            className="text-lg md:text-xl text-blue-800/90 font-medium mb-2"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <motion.div
                    key={idx}
                    className="bg-white/80 p-4 rounded-lg shadow flex-1 min-w-[160px]"
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {team.map((member, idx) => (
            <motion.div
              key={member.name}
              className="bg-white/80 rounded-xl shadow-lg p-6 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-transform duration-300"
